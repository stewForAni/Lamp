 ...
 */
public class TwinkleFragment extends Fragment {
    private View rootView;
    private String order = CommandUtils.TWIN_1;
    private String speed = CommandUtils.SPEED_1;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_twinkle, container, false);
        return rootView;
    }
    ...
    private void initView() {
        SeekBar seekBar = (SeekBar) rootView.findViewById(R.id.seekBar_twinkle);
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (progress < 25) {
                    ...
                    order = CommandUtils.TWIN_1;
                } else if (progress < 75) {
                    seekBar.setProgress(50);
                    order = CommandUtils.TWIN_2;
                } else {
                    seekBar.setProgress(100);
                    order = CommandUtils.TWIN_3;
                }
